...
class WG_oPhim_Categories extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <?php if ($query->have_posts()) : ?>
            <?php
                if($style == 4 ){
                    include THEME_URL.'/templates/section/section_poster_1.php';
                }
                if($style == 5 ){
                    include THEME_URL.'/templates/section/section_poster_2.php';
                }
            ?>
        <?php endif; ?>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <br>
            <?php
            $f = array( '4' => __('Kiểu 1', 'ophim'), '5' => __('Kiểu 2', 'ophim'));
            foreach ($f as $x => $n ) { ?>
