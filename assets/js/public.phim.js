jQuery(document).ready(function () {
    ...
    jQuery("#star").raty({
        ...
        number: 10,
        numberMax: 10,
        starOff: TEMURL+"/assets/libs/jquery-raty/images/star-off.png",
        starOn: TEMURL+"/assets/libs/jquery-raty/images/star-on.png",
        starHalf: TEMURL+"/assets/libs/jquery-raty/images/star-half.png",
        score: function () {
